...
class DatabaseService {
    ...
    static async createServiceTable() {
      ...
      CREATE TABLE IF NOT EXISTS Service (
        ...
        security_level TEXT DEFAULT 'insecure' CHECK (security_level IN ('secure', 'sensitive', 'insecure')),
        accoustic TEXT,
        model_quality TEXT,
        model_type TEXT,
        language TEXT
    ...
    static async addSecurityLevelColumn() {
        try {
            ...
            if (!hasSecurityLevel) {
                await DatabaseService.db.exec(`ALTER TABLE Service ADD COLUMN security_level TEXT DEFAULT 'insecure'`)
    ...
    static async getAllServices() {
        try {
            ...
            return services.map(service => {
                // Ensure security_level has a default value
                if (!service.security_level) {
                    service.security_level = SECURITY_LEVEL.DEFAULT
                }
